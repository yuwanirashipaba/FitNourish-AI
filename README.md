...
2.The system calculates the total cost of the list for each store.
3.Store recommendations are generated by considering:
   - Promotional prices
   - Total list cost
   - Physical distance to the store
4.The app highlights:
    - Best store for highest savings
